    ...
    return (
        <div className="App">
            <header className="headerClass">
                <img className="logoaccueil"
                     src="https://images.ctfassets.net/gi6fitfj7iu4/5pPJ6ZLR5irhfpobU6DQlW/689df14ded419613f908e21c700d5878/LOGO_BEAN.png?q=80&w=800"></img>
            ...
            <div>
                ...
                <div>
                    ...
                    {dataPages.acf.image.map((item, index) => (
                        <img className={`img_${index}`} key={index} src={item} alt="img" height="350vh"
                             width="80%"></img>))}
                </div>
            </div>
